...
document.location="reportsedit3.php";
</script>
...
<?php
	...
	{
$q=mysqli_query($con,"update donar
	set dname='$dname',demail='$demail',dmobile='$dmobile',image='$target_file',dfaddr='$dfaddr',dbg='$dbg' where dname='$dname'");
	if($q)
	{
	?>
	<script>
	alert("EDITED DONAR REPORT");
	document.location="reportsedit3.php";
	</script>
	<?php
	}
