				...
				<div  class="col-md-12 col">
					<div class="col-md-4 col3">
						<ul class="nav nav-tabs tabs-left">
							...
							<li class="active"><a href="#stock" data-toggle="tab">Blood Stock</a></li>
					...
					<!-- Tab panes -->
						<div class="tab-content">
							<div class="tab-pane" id="group"><h1>Blood Group</h1>
								<div class="div3">
									<ul class="b">
										...
										<li class="b"><a href="reportsedit.php">Edit</a></li>
										<li class="b"><a class="active" href="reportsdel.php">Delete</a></li>
									</ul><hr>
								</div>
								<form action="reportsdelj.php" method="post" style="float: right-side;right:100px;">
									<div class="container">
							...
							<div class="tab-pane active" id="stock"><h1>Blood Stock</h1>		
								<div class="div3">
									<ul class="b">
										<li class="b" ><a href="reports.php">List</a></li>
										<li class="b"><a href="reportsedit1.php">Edit</a></li>
										<li class="b"><a class="active" href="reportsdel1.php">Delete</a></li>
										
									</ul><hr>
								</div>
								<form action="reportsdelj1.php" method="post" style="float: right-side;right:100px;">
									<div class="container">
							...
							<div class="tab-pane" id="sells"><h1>Blood Sells</h1>		
								<div class="div3">
									<ul class="b">
										<li class="b" ><a href="reports.php">List</a></li>
										<li class="b"><a href="reportsedit1.php">Edit</a></li>
										<li class="b"><a class="active" href="reportsdel2.php">Delete</a></li>
										
									</ul><hr>
								</div>
								<form action="reportsdelj2.php" method="post" style="float: right-side;right:100px;">
									<div class="container">
							...
							<div class="tab-pane" id="donars"><h1>Donars</h1>		
								<div class="div3">
									<ul class="b">
										<li class="b" ><a href="reports.php">List</a></li>
										<li class="b"><a href="reportsedit1.php">Edit</a></li>
										<li class="b"><a class="active" href="reportsdel3.php">Delete</a></li>
										
									</ul><hr>
								</div>
								<form action="reportsdelj3.php" method="post" style="float: right-side;right:100px;">
									<div class="container">
