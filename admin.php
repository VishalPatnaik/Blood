							...
							<div class="container-fluid">
								...
								<div class="collapse navbar-collapse" id="myNavbar">
									<ul class="nav navbar-nav navbar-right">
										...
										<li class="Nav"><a href="admin.php">MY ACCOUNT</a></li>
			...
			<div class="featured-content">
				...
				<div class="row">
					<div class="page-title">
						<h1 class="nomargin"> Administrator</h1>
					</div>
				</div>
			</div>
						...
						<div class="tab-content">
							<div class="tab-pane active" id="view"><h1>View</h1>		
								<?php
									...
									$result=mysqli_query($con,"select ufullname,uemail,uno,uadd,uadhaar,ustate,ucountry from adminreg");
							...
							<div class="tab-pane" id="edit"><h1>Edit</h1>		
								<form action="admineditj.php" method="post" style="float: right-side;right:100px;">
									<div class="container">
										...
										<input type="text" placeholder="Enter Your Country..." name="ucountry" required><br>
							...
							<div class="tab-pane" id="contact"><h1>Messages Received</h1>		
								<?php
									$con=mysqli_connect("localhost","root","","cse")or die(mysqli_error());
									$c=mysqli_select_db($con,"cse")or die(mysql_error());
									$result=mysqli_query($con,"select * from contact");
									echo "<center><u><h1>List of Received Messages</h1></u></center>";
									echo "<center>
									<table align=center height=70 width=700 border=3px>
									<tr ><br>
									<td ><h5>&nbsp&nbspYOUR NAME</h5></td>
									<td><h5>&nbsp&nbspYOUR EMAIL</h5></td>
									<td><h5>&nbsp&nbspCONTACT</h5></td>
									<td><h5>&nbsp&nbspSUBJECT</h5></td>
									<td><h5>&nbsp&nbspMESSAGE</h5></td>
									</tr>";
									while($row=mysqli_fetch_array($result))
									{
									echo"<tr>";
									echo"<td>&nbsp&nbsp".$row['yourname']."</td>";
									echo"<td>&nbsp&nbsp".$row['youremail']."</td>";
									echo"<td>&nbsp&nbsp".$row['contact']."</td>";
									echo"<td>&nbsp&nbsp".$row['subject']."</td>";
									echo"<td>&nbsp&nbsp".$row['query']."</td>";
									echo"</tr>";
									}
